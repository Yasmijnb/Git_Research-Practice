...
loadings(loadings(:,1) < threshold1, 1)=0;
loadings(loadings(:,2) < threshold2, 2)=0;
loadings(loadings(:,3) < threshold3, 3)=0;
loadings(loadings(:,4) < threshold4, 4)=0;

%% Save loadings

writematrix(scores, 'COVSCA_scores.csv')
writematrix(loadings, 'COVSCA_loadings.csv')
